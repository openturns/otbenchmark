...
class CheckSensitivityConvergenceBenchmark(unittest.TestCase):
    def test_plotConvergenceGrid(self):
        ...
        sobolIndicesAlgorithm = ot.SaltelliSensitivityAlgorithm()
        grid = benchmark.plotConvergenceGrid(sobolIndicesAlgorithm, verbose=True)
        otv.View(grid)
    ...
    def test_computeError(self):
        ...
        sobolIndicesAlgorithm = ot.SaltelliSensitivityAlgorithm()
        sample_size = 40000
        first_order_AE, total_order_AE = benchmark.computeError(
    ...
    def test_computeSobolSample(self):
        ...
        (
            ...
            first_order_table,
            total_order_table,
        ) = benchmark.computeSobolSample(sobolIndicesAlgorithm)
